#!/usr/bin/env bash
# E4: ML entry v1 + direction ML; stagnant_exit_bars=20 + shadow-gated stagnant defer.
set -euo pipefail
...
upsert STRATEGY_PROFILE_ID trader_master_ml_entry_v1_stagnant_20_dyn_exit
...
echo "Patched $ENV_FILE for trader_master_ml_entry_v1_stagnant_20_dyn_exit + direction ML"
