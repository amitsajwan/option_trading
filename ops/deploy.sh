...
CORE_SERVICES="ingestion_app ingestion_app_nifty ingestion_app_finnifty ingestion_app_sensex snapshot_app snapshot_app_nifty snapshot_app_finnifty snapshot_app_sensex strategy_app strategy_app_nifty strategy_app_finnifty strategy_app_sensex execution_app execution_app_nifty execution_app_finnifty execution_app_sensex seller_app seller_app_nifty seller_app_finnifty seller_app_sensex"
