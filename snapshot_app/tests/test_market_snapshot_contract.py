...
def _valid_snapshot() -> dict:
    return {
        ...
        "opening_range": {
            ...
            "orh_broken": False,
            "orl_broken": False,
            "bars_since_or_break_up": None,
            "bars_since_or_break_down": None,
        },
        "vix_context": {
            "vix_current": 15.0,
            "vix_prev_close": 14.8,
        ...
        "chain_aggregates": {
            ...
            "ce_pe_oi_diff": -1000.0,
            "ce_pe_volume_diff": 100.0,
            "atm_straddle_price": 190.0,
            "atm_straddle_pct": 0.0038,
            "distance_to_max_pain_pct": 0.0001,
        },
        "ladder_aggregates": {
            "near_atm_pcr": 1.08,
            ...
            "oi_sum_m3_p3_pe": 11000.0,
            "vol_sum_m3_p3_ce": 1000.0,
            "vol_sum_m3_p3_pe": 900.0,
        },
        "atm_options": {
            "atm_ce_strike": 50000,
            "atm_ce_open": 98.0,
            ...
            "atm_pe_low": 88.0,
            "atm_pe_close": 90.0,
            "atm_pe_return_1m": -0.005,
            "atm_pe_volume": 900,
            "atm_pe_oi": 11000,
            "atm_pe_oi_change_1m": 20,
