...
def test_main_fails_closed_on_partial_normalization(tmp_path, monkeypatch) -> None:
    monkeypatch.setattr(
        argparse.ArgumentParser,
        "parse_args",
        lambda self: argparse.Namespace(
    ...
    monkeypatch.setattr(
        ...
        lambda **kwargs: {"status": "partial_error", "errors": [{"dataset": "options", "year": 2021, "month": 4}]},
    )
