...
class HistoricalReplayAppTests(unittest.TestCase):
    ...
    def test_historical_replay_page_renders(self) -> None:
        ...
        self.assertIn(b"Session Day Replay", response.body)
        self.assertIn(b"All Trades In Range", response.body)
        self.assertIn(b"Open Compare Page", response.body)
        ...
        self.assertIn(b"Trade Day Navigator", response.body)
        self.assertIn(b"Clickable Trade Dates", response.body)
