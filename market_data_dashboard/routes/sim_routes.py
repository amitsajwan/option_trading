...
ALLOWED_ENV_OVERRIDE_KEYS = {
    ...
    "SMART_STRIKE_OTM2_MIN_OI",
    "SMART_STRIKE_OTM3_ENABLED",
    "SMART_STRIKE_OTM3_CONFIDENCE",
    "SMART_STRIKE_OTM3_IV_CEIL",
    "SMART_STRIKE_OTM3_REGIMES",
    "SMART_STRIKE_OTM3_MAX_BAR_HOUR",
    "SMART_STRIKE_OTM3_MIN_OI",
    "SMART_STRIKE_OTM4_ENABLED",
    "SMART_STRIKE_OTM4_CONFIDENCE",
    "SMART_STRIKE_OTM4_IV_CEIL",
    "SMART_STRIKE_OTM4_REGIMES",
    "SMART_STRIKE_OTM4_MAX_BAR_HOUR",
    "SMART_STRIKE_OTM4_MIN_OI",
    "SIDEWAYS_RETURNS_MIXED_GATE_ENABLED",
