...
def risk_state_payload(risk_manager: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "halt_reason": str(getattr(risk_manager, "halt_reason", None) or "").strip() or None,
        "pause_reason": str(getattr(risk_manager, "pause_reason", None) or "").strip() or None,
        ...
        "session_trade_count": int(getattr(ctx, "session_trade_count", 0) or 0),
        ...
        "session_trade_cap_breached": bool(getattr(ctx, "session_trade_cap_breached", False)),
